...
namespace Planc.Models
{
    ...
    public class ApplicationUserManager : UserManager<Player>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Player>(context.Get<ApplicationIdentityContext>()));
        ...
        {
            var userRoleStore = (IUserRoleStore<Player, string>)Store;
    ...
    public class SignInHelper
    {
        ...
        public async Task SignInAsync(Player user, bool isPersistent, bool rememberBrowser)
        {
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(Player user, bool isPersistent)
        {
